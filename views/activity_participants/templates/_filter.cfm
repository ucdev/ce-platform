...
<ul class="dropdown-menu js-attendees-filter">
    <li class="attendee-status js-attendee-status-all" id="status0"><a href="#"><span class="js-attendee-status-name">All</span> <span class="js-attendee-status-count"></span></a></li>
    <li class="divider"></li>
