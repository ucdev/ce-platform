...
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[ceschema].[View_PreferredPifFull]'))
	...
	';
IF NOT EXISTS (SELECT * FROM ::fn_listextendedproperty(N'MS_DiagramPane1' , N'SCHEMA',N'ceschema', N'VIEW',N'View_PreferredPifFull', NULL,NULL))
...
IF NOT EXISTS (SELECT * FROM ::fn_listextendedproperty(N'MS_DiagramPane2' , N'SCHEMA',N'ceschema', N'VIEW',N'View_PreferredPifFull', NULL,NULL))
	...
	End
	' , @level0type=N'SCHEMA',@level0name=N'ceschema', @level1type=N'VIEW',@level1name=N'View_PreferredPifFull';
IF NOT EXISTS (SELECT * FROM ::fn_listextendedproperty(N'MS_DiagramPaneCount' , N'SCHEMA',N'ceschema', N'VIEW',N'View_PreferredPifFull', NULL,NULL))
...
SET ANSI_NULLS ON;
SET QUOTED_IDENTIFIER ON;
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[ceschema].[View_FullPIFaudit]'))
	...
	';
IF NOT EXISTS (SELECT * FROM ::fn_listextendedproperty(N'MS_DiagramPane1' , N'SCHEMA',N'ceschema', N'VIEW',N'View_FullPIFaudit', NULL,NULL))
	EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane1', @value=N'[0E232FF0-B466-11cf-A24F-00AA00A3EFFF, 1.00]
	Begin DesignProperties = 
	Begin PaneConfigurations = 
	Begin PaneConfiguration = 0
...
IF NOT EXISTS (SELECT * FROM ::fn_listextendedproperty(N'MS_DiagramPane2' , N'SCHEMA',N'ceschema', N'VIEW',N'View_FullPIFaudit', NULL,NULL))
	EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane2', @value=N' End
	End
	End
	' , @level0type=N'SCHEMA',@level0name=N'ceschema', @level1type=N'VIEW',@level1name=N'View_FullPIFaudit';
IF NOT EXISTS (SELECT * FROM ::fn_listextendedproperty(N'MS_DiagramPaneCount' , N'SCHEMA',N'ceschema', N'VIEW',N'View_FullPIFaudit', NULL,NULL))
...
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ac_object_locked]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ac_object]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ac_operation__create]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ac_operation]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ac_operation__read]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ac_operation]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ac_operation__update]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ac_operation]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ac_operation__delete]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ac_operation]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ac_operation_locked]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ac_operation]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ac_session_created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ac_session]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Group_uuid]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ac_tenant]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Group_created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ac_tenant]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Group_deletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ac_tenant]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_ACL_TenantType_created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ac_tenantkind]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ac_user_role_tenant_id]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ac_user_role]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Account_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Account]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Account_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Account]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Action_Code]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Action]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Action_HiddenFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Action]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Action_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Action]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Action_MovedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Action]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_SessionType]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_StatMaxRegistrants]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_AttendeeCount]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_StatAddlAttendees]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_StatCMEHours]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_MDCount]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_NonMDCount]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_StatSupporters]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_StatSuppAmount]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_refreshFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Course_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Course_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Application_ReceivedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Application]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Application_SentFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Application]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Application_ApprovedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Application]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Application_NeedsFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Application]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Application_ObjFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Application]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Application_SuppFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Application]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Application_AttendFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Application]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Application_CVFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Application]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Application_BrochFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Application]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Application_MembApprFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Application]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Application_ConflictFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Application]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Application_EvalFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Application]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Category_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Category]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Category_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Category]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_LMS_Category_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_CategoryLMS]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_LMS_Category_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_CategoryLMS]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Comment_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Comment]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Comment_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Comment]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_CourseCommittee_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Committee]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_CourseCommittee_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Committee]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Credit_Amount]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Credit]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_CourseCredit_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Credit]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_CourseCredit_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Credit]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Faculty_]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Faculty]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Faculty_DisclosureApproveFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Faculty]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Faculty_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Faculty]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Faculty_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Faculty]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_FinBudget_Amount]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_FinBudget]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_FinBudget_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_FinBudget]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_FinBudget_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_FinBudget]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_FinFee_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_FinFee]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_FinFee_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_FinFee]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_FinLedger_Amount]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_FinLedger]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_FinLedger_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_FinLedger]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_FinLedger_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_FinLedger]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_CourseContrib_Amount]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_FinSupport]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_CourseContrib_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_FinSupport]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_CourseContrib_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_FinSupport]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_CourseNote_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Note]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_CourseNote_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Note]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Other_DidacticHrs]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Other]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Other_ExperimentalHrs]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Other]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_CourseCDC_SecClinSiteFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Other]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_CourseCDC_CollabPTCFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Other]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_CourseCDC_CollabAgencyFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Other]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Other_competenceDesign]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Other]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Other_performanceDesign]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Other]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Other_outcomesDesign]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Other]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Other_competenceEval]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Other]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Other_performanceEval]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Other]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Other_outcomesEval]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Other]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_PubComponent_RequiredFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_PubComponent]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_PubComponent_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_PubComponent]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_PubComponent_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_PubComponent]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_PubGeneral_PublishFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_PubGeneral]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_PubGeneral_RequirePayment]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_PubGeneral]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_PubGeneral_PaymentFee]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_PubGeneral]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_PubGeneral_TermsFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_PubGeneral]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_PubGeneral_AllowFeedback]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_PubGeneral]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_PubGeneral_AllowCommentFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_PubGeneral]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_PubGeneral_CommentApproveFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_PubGeneral]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_PubGeneral_StatViews]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_PubGeneral]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_PubGeneral_StatVoteCount]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_PubGeneral]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_PubGeneral_StatVoteValue]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_PubGeneral]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_PubGeneral_FeaturedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_PubGeneral]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_PubGeneral_extHostFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_PubGeneral]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_PubGeneral_RestrictedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_PubGeneral]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Site_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Site]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Site_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Site]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_SpecialtyLMS_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_SpecialtyLMS]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_SpecialtyLMS_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_SpecialtyLMS]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Step_created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_activity_step]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Step_deletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_activity_step]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_activity_tag_tagcount]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_activity_tags]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_activity_tags_hideflag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_activity_tags]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_User_is_approved]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_activity_user]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_User_created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_activity_user]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Activity_Vote_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Vote]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Agenda_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Agenda]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_AssessAnswer_CorrectFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessAnswer]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_TestAnswer_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessAnswer]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_TestAnswer_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessAnswer]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Test_MaxAttempts]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Assessment]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Test_RequiredFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Assessment]'))
	Begin
