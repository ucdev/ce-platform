...
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Test_RandomFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Assessment]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Test_CommentFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Assessment]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Test_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Assessment]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Test_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Assessment]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_TestQuestion_RequiredFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessQuestion]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_AssessQuestion_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessQuestion]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_TestQuestion_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessQuestion]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_TestResult_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessResult]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_TestResult_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessResult]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_TestSection_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessSection]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_TestSection_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessSection]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Assess_Tmpl_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessTmpl]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Assess_Tmpl_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessTmpl]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_CourseSect_Person_CheckedInFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Attendee]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_CourseSect_Person_CheckedOutFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Attendee]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Attendee_MDflag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Attendee]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Attendee_emailSentFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Attendee]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_CourseSect_Person_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Attendee]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Attendee_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Attendee]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Attendee_Component_LikeFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Attendee_Component]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Attendee_Component_Updated]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Attendee_Component]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Attendee_Step_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Attendee_Step]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_AttendeeCDC_Updates]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AttendeeCDC]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_AttendeeCDC_Eval]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AttendeeCDC]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_AttendeeCDC_TrainingAlert]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AttendeeCDC]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_AttendeeCDC_CurrentlyEnrolled]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AttendeeCDC]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_AttendeeCDC_RelevantTraining]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AttendeeCDC]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_AttendeeCDC_MotivationTraining]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AttendeeCDC]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_AttendeeCDC_SentFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AttendeeCDC]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_AttendeeCDC_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AttendeeCDC]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_AttendeeCDC_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AttendeeCDC]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_AttendeeCredit_Amount]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AttendeeCredit]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_AttendeeCredit_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AttendeeCredit]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_AttendeeCredit_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AttendeeCredit]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Authority_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Authority]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Authority_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Authority]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_AuthorityPage_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AuthorityPage]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_AuthorityPage_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AuthorityPage]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Category_ActivityCount]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Category]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Category_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Category]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Category_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Category]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Category_primary_image_id]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Category]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Cert_deletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Cert]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Cert_Credit_created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Cert_Credit]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_Table_1_ApproveFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Comment]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Comment_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Comment]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Comment_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Comment]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Credit_Cert_created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Credit_Cert]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_degree_created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_degree]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_degree_deletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_degree]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_Degree_Credit_sort]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Degree_Credit]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_Degree_Credit_created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Degree_Credit]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_entity_category_id]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_entity]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_entity_sub_category_id]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_entity]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_entity_uuid]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_entity]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_entity_parent_entity_id]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_entity]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_entity_stat_users]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_entity]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_entity_is_verified]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_entity]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_entity_primary_image_id]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_entity]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_entity_created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_entity]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_entity_deletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_entity]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_entity_person_role_id]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_entity_person]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_user_entity_is_verified]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_entity_person]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_user_entity_created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_entity_person]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_File_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_File]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_File_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_File]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_FileGroup_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_FileGroup]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_FileGroup_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_FileGroup]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Client_clientGUID]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Group]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Partner_accreditedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Group]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Client_created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Group]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Client_deletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Group]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Partner_Type_sort]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_GroupType]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Partner_Type_created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_GroupType]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_History_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_History]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_History_HiddenFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_History]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_hub_isWikipedia]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_hub]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_hub_created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_hub]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_image_created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_image]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_location_created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_location]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_locationType_created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_locationType]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_object_uuid]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_object]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_object_created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_object]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_object_deletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_object]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_objectData_created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_objectData]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_objectData_deletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_objectData]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_objectField_created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_objectField]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_occupation_created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_occupation]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Page_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_page]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Page_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_page]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_page_section_sort]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_page_section]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_page_section_show_label]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_page_section]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_page_section_show_rule]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_page_section]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_pageLayoutMenu_page_show_icon]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_pageLayoutMenu_page]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_pageLayoutMenu_page_show_stat]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_pageLayoutMenu_page]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_pageLayoutMenu_page_sort]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_pageLayoutMenu_page]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Person_Gender]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Person]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Person_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Person]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Person_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Person]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Person_Address_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Person_Address]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Person_Client_revokeFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Person_Client]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Person_Client_created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Person_Client]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Person_Client_deletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Person_Client]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Person_Degree_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Person_Degree]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Person_Degree_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Person_Degree]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_person_email_is_verified]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Person_Email]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_person_email_allow_login]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Person_Email]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Person_File_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Person_File]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Person_File_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Person_File]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Person_Interest_Exception_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Person_Interest_Except]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_PersonNote_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Person_Note]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_PersonNote_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Person_Note]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Person_Pref_createdAt]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Person_Pref]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Person_SpecialtyLMS_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Person_SpecialtyLMS]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Person_SpecialtyLMS_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Person_SpecialtyLMS]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_person_user_primary_entity_id]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_person_user]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Process_HiddenFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Process]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Process_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Process]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Process_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Process]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Process_Person_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Process_Person]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Process_Person_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Process_Person]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_ProcessManager_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_ProcessManager]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_ProcessManager_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_ProcessManager]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_ProcessStep_NotifyFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_ProcessStep]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_ProcessStep_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_ProcessStep]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_ProcessStep_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_ProcessStep]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_ProcessStep_Course_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_ProcessStep_Activity]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_ProcessStep_Course_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_ProcessStep_Activity]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_professionArea_parent_id]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_professionArea]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Project_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Project]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Project_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Project]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_relicensure_created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_relicensure]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_relicensure_deletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_relicensure]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Subscription_OptInDate]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Subscription]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Subscription_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Subscription]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Subscription_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Subscription]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_ActivityStepType_Sort]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_ActivityStepType]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_CourseType_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_ActivityType]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_CourseType_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_ActivityType]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_apiClient_statUsers]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_apiClient]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_apiClient_statCalls]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_apiClient]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_apiClient_statUpdate]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_apiClient]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_apiClient_statSignup]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_apiClient]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_apiClient_statLogin]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_apiClient]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_apiClient_created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_apiClient]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_QuestionType_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_AssessQuestionType]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_QuestionType_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_AssessQuestionType]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_ResultStatus_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_AssessResultStatus]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_ResultStatus_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_AssessResultStatus]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_CategoryLMS_created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_CategoryLMS]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_CategoryLMS_deletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_CategoryLMS]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_CBAFund_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_CBAFund]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_CBOFund_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_CBOFund]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_Component_SortFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_Component]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_Component_MaxUsage]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_Component]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_Credit_ReferenceFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_Credit]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Credit_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_Credit]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Credit_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_Credit]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_EntryType_ExpenseFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_EntryType]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_EntryType_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_EntryType]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_FunRC_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_FunRC]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_FunRN_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_FunRN]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_Grouping_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_Grouping]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ur__HistoryStyle_PossessiveFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_HistoryStyle]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_Market_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_Market]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_OccClass_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_OccClass]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_OrgType_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_OrgType]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_PrinEmp_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_PrinEmp]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_ProfC_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_ProfC]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_ProfN_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_ProfN]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_ProjectType_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_ProjectType]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_Report_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_Report]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_SiteLMS_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_SiteLMS]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_SiteLMS_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_SiteLMS]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_SpecialtyLMS_created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_SpecialtyLMS]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_SpecialtyLMS_deletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_SpecialtyLMS]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_Status_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_Status]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Contributor_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_Supporter]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Contributor_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_Supporter]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_ContribType_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_SupportType]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_ContribType_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_SupportType]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_TestType_Created]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_TestType]'))
	Begin
	...
	End;
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[ceschema].[DF_ce_Sys_TestType_DeletedFlag]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Sys_TestType]'))
	Begin
	...
	End;
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[ceschema].[FK_ce_CourseCredit_ce_Credit]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Credit]'))
...
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[ceschema].[FK_ce_CourseCredit_ce_Credit]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Credit]'))
	ALTER TABLE [ceschema].[ce_Activity_Credit] CHECK CONSTRAINT [FK_ce_CourseCredit_ce_Credit];
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[ceschema].[FK_ce_AssessAnswer_ce_Assessment]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessAnswer]'))
...
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[ceschema].[FK_ce_AssessAnswer_ce_Assessment]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessAnswer]'))
	ALTER TABLE [ceschema].[ce_AssessAnswer] CHECK CONSTRAINT [FK_ce_AssessAnswer_ce_Assessment];
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[ceschema].[FK_ce_AssessAnswer_ce_AssessQuestion]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessAnswer]'))
...
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[ceschema].[FK_ce_AssessAnswer_ce_AssessQuestion]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessAnswer]'))
	ALTER TABLE [ceschema].[ce_AssessAnswer] CHECK CONSTRAINT [FK_ce_AssessAnswer_ce_AssessQuestion];
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[ceschema].[FK_ce_AssessAnswer_ce_AssessResult]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessAnswer]'))
...
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[ceschema].[FK_ce_AssessAnswer_ce_AssessResult]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessAnswer]'))
	ALTER TABLE [ceschema].[ce_AssessAnswer] CHECK CONSTRAINT [FK_ce_AssessAnswer_ce_AssessResult];
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[ceschema].[FK_ce_Assessment_ce_Sys_AssessType]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Assessment]'))
...
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[ceschema].[FK_ce_Assessment_ce_Sys_AssessType]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_Assessment]'))
	ALTER TABLE [ceschema].[ce_Assessment] CHECK CONSTRAINT [FK_ce_Assessment_ce_Sys_AssessType];
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[ceschema].[FK_ce_AssessQuestion_ce_Assessment]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessQuestion]'))
	...
	REFERENCES [ceschema].[ce_Assessment] ([AssessmentID]);
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[ceschema].[FK_ce_AssessQuestion_ce_Assessment]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessQuestion]'))
	ALTER TABLE [ceschema].[ce_AssessQuestion] CHECK CONSTRAINT [FK_ce_AssessQuestion_ce_Assessment];
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[ceschema].[FK_ce_AssessQuestion_ce_AssessSection]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessQuestion]'))
...
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[ceschema].[FK_ce_AssessQuestion_ce_AssessSection]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessQuestion]'))
	ALTER TABLE [ceschema].[ce_AssessQuestion] CHECK CONSTRAINT [FK_ce_AssessQuestion_ce_AssessSection];
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[ceschema].[FK_ce_AssessResult_ce_Assessment]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessResult]'))
	ALTER TABLE [ceschema].[ce_AssessResult]  WITH CHECK ADD  CONSTRAINT [FK_ce_AssessResult_ce_Assessment] FOREIGN KEY([AssessmentID])
	REFERENCES [ceschema].[ce_Assessment] ([AssessmentID]);
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[ceschema].[FK_ce_AssessResult_ce_Assessment]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessResult]'))
	ALTER TABLE [ceschema].[ce_AssessResult] CHECK CONSTRAINT [FK_ce_AssessResult_ce_Assessment];
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[ceschema].[FK_ce_AssessResult_ce_Sys_AssessResultStatus]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessResult]'))
...
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[ceschema].[FK_ce_AssessResult_ce_Sys_AssessResultStatus]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessResult]'))
	ALTER TABLE [ceschema].[ce_AssessResult] CHECK CONSTRAINT [FK_ce_AssessResult_ce_Sys_AssessResultStatus];
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[ceschema].[FK_ce_AssessSection_ce_Assessment]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessSection]'))
	...
	REFERENCES [ceschema].[ce_Assessment] ([AssessmentID]);
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[ceschema].[FK_ce_AssessSection_ce_Assessment]') AND parent_object_id = OBJECT_ID(N'[ceschema].[ce_AssessSection]'))
