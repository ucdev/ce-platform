<cfcomponent extends="plugins.dbmigrate.Migration" hint="INITIAL DB 2">
  <cffunction name="up">
	...
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_Person_Degree]') AND type in (N'U'))
	BEGIN
	...
	execute("IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'[ceschema].[ce_Person_Degree]') AND name = N'Degree ID')
	...
	announce("Object:  Table [ceschema].[ce_Sys_AssessQuestionType]    Script Date: 05/31/2012 10:19:07");
execute("SET ANSI_NULLS ON");

	execute("SET QUOTED_IDENTIFIER ON");

	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_Sys_AssessQuestionType]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_entitytype]    Script Date: 05/31/2012 10:19:07");
execute("SET ANSI_NULLS ON");

	execute("SET QUOTED_IDENTIFIER ON");

	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_entitytype]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_Activity_Application]    Script Date: 05/31/2012 10:19:07");
execute("SET ANSI_NULLS ON");

	execute("SET QUOTED_IDENTIFIER ON");

	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Application]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[geonameCities]    Script Date: 05/31/2012 10:19:07");
execute("SET ANSI_NULLS ON");

	execute("SET QUOTED_IDENTIFIER ON");

	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[geonameCities]') AND type in (N'U'))
	BEGIN
	...
	execute("IF not EXISTS (SELECT * FROM sys.fulltext_indexes fti WHERE fti.object_id = OBJECT_ID(N'[ceschema].[geonameCities]'))
	...
	announce("Object:  Table [ceschema].[ce_Sys_AssessType]    Script Date: 05/31/2012 10:19:07");
execute("SET ANSI_NULLS ON");

	execute("SET QUOTED_IDENTIFIER ON");

	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_Sys_AssessType]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ac_operation]    Script Date: 05/31/2012 10:19:07");
execute("SET ANSI_NULLS ON");

	execute("SET QUOTED_IDENTIFIER ON");

	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ac_operation]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_entity_entityrole]    Script Date: 05/31/2012 10:19:07");
execute("SET ANSI_NULLS ON");

	execute("SET QUOTED_IDENTIFIER ON");

	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_entity_entityrole]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_Attendee_Component]    Script Date: 05/31/2012 10:19:07");
execute("SET ANSI_NULLS ON");

	execute("SET QUOTED_IDENTIFIER ON");

	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_Attendee_Component]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_Activity_FinBudget]    Script Date: 05/31/2012 10:19:07");
execute("SET ANSI_NULLS ON");

	execute("SET QUOTED_IDENTIFIER ON");

	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_Activity_FinBudget]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_Attendee]    Script Date: 05/31/2012 10:19:07");
execute("SET ANSI_NULLS ON");

	execute("SET QUOTED_IDENTIFIER ON");

	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_Attendee]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[geonameCountryInfo]    Script Date: 05/31/2012 10:19:07");
execute("SET ANSI_NULLS ON");

	execute("SET QUOTED_IDENTIFIER ON");

	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[geonameCountryInfo]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_hub]    Script Date: 05/31/2012 10:19:07");
execute("SET ANSI_NULLS ON");

	execute("SET QUOTED_IDENTIFIER ON");

	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_hub]') AND type in (N'U'))
	BEGIN
