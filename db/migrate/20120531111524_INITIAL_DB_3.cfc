<cfcomponent extends="plugins.dbmigrate.Migration" hint="INITIAL DB 3">
  <cffunction name="up">
	...
	announce("Object:  Table [ceschema].[ce_occupation]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_occupation]') AND type in (N'U'))
	BEGIN
	...
	execute("IF not EXISTS (SELECT * FROM sys.fulltext_indexes fti WHERE fti.object_id = OBJECT_ID(N'[ceschema].[ce_occupation]'))
	...
	announce("Object:  UserDefinedFunction [dbo].[HTMLDecode]    Script Date: 05/31/2012 10:19:08");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[HTMLDecode]') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_degree]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_degree]') AND type in (N'U'))
	BEGIN
	...
	execute("IF not EXISTS (SELECT * FROM sys.fulltext_indexes fti WHERE fti.object_id = OBJECT_ID(N'[ceschema].[ce_degree]'))
	...
	announce("Object:  UserDefinedFunction [dbo].[ReplaceInvChar]    Script Date: 05/31/2012 10:19:08");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ReplaceInvChar]') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_Sys_Status]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_Sys_Status]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  UserDefinedFunction [ceschema].[cleanEmailDomain]    Script Date: 05/31/2012 10:19:08");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[cleanEmailDomain]') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_Sys_ProfC]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_Sys_ProfC]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ac_permission]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ac_permission]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_Person_Email]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_Person_Email]') AND type in (N'U'))
	BEGIN
	...
	execute("IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'[ceschema].[ce_Person_Email]') AND name = N'IX_ce_person_email')
	...
	execute("IF NOT EXISTS (SELECT * FROM ::fn_listextendedproperty(N'MS_Description' , N'SCHEMA',N'ceschema', N'TABLE',N'ce_Person_Email', N'INDEX',N'IX_ce_person_email'))
	...
	announce("Object:  Table [ceschema].[ac_role]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ac_role]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_Activity_Comment]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_Activity_Comment]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[xLegacy_STDCourseList]    Script Date: 05/31/2012 10:19:08");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[xLegacy_STDCourseList]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_Degree_Credit]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_Degree_Credit]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ac_session_role]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ac_session_role]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_Project]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_Project]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[xLegacy_tt_Course]    Script Date: 05/31/2012 10:19:08");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[xLegacy_tt_Course]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ac_user_session]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ac_user_session]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[xLegacy_tt_CourseSection]    Script Date: 05/31/2012 10:19:08");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[xLegacy_tt_CourseSection]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[xLegacy_cm_Registration]    Script Date: 05/31/2012 10:19:08");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[xLegacy_cm_Registration]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_page_section]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_page_section]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_Activity_PubStep]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_Activity_PubStep]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_Sys_ProfN]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_Sys_ProfN]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_sys_stat_type]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	...
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_sys_stat_type]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_AttendeeCDC]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	...
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_AttendeeCDC]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_iislog]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_iislog]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_Agenda]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_Agenda]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[geonames_zip]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[geonames_zip]') AND type in (N'U'))
	BEGIN
	...
	execute("IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'[ceschema].[geonames_zip]') AND name = N'IX_admincode1')
	CREATE NONCLUSTERED INDEX [IX_admincode1] ON [ceschema].[geonames_zip] 
	(
	[admincode1] ASC
	)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'[ceschema].[geonames_zip]') AND name = N'IX_countrycode')
	CREATE NONCLUSTERED INDEX [IX_countrycode] ON [ceschema].[geonames_zip] 
	(
	[countrycode] ASC
	)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'[ceschema].[geonames_zip]') AND name = N'IX_place')
	CREATE NONCLUSTERED INDEX [IX_place] ON [ceschema].[geonames_zip] 
	(
	[placename] ASC
	)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'[ceschema].[geonames_zip]') AND name = N'IX_zip')
	CREATE NONCLUSTERED INDEX [IX_zip] ON [ceschema].[geonames_zip] 
	(
	[postalcode] ASC
	)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]");
	
	announce("Object:  Table [ceschema].[ce_Person_Pref]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_Person_Pref]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[geoname_admin1CodesASCII]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[geoname_admin1CodesASCII]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_activity_user]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_activity_user]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_Sys_AddressType]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_Sys_AddressType]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_Subscription]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_Subscription]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_stat_log]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_stat_log]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_Sys_AttendeeStatus]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_Sys_AttendeeStatus]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_Activity_CategoryLMS]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_Activity_CategoryLMS]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_stat_entry]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_stat_entry]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_imagetype]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_imagetype]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_person_user]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_person_user]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_Sys_CategoryLMS]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_Sys_CategoryLMS]') AND type in (N'U'))
	BEGIN
	...
	announce("Object:  Table [ceschema].[ce_Authority]    Script Date: 05/31/2012 10:19:07");
	execute("SET ANSI_NULLS ON");
	
	execute("SET QUOTED_IDENTIFIER ON");
	
	execute("IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ceschema].[ce_Authority]') AND type in (N'U'))
	BEGIN
