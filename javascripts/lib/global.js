...
ce.module("global", function(self, ce, Backbone, Marionette, $, _) {
  var StatusCount, SubmitForm, getResources, getSprites, historyList, listHistory, prettyDate, renderHistoryItem;
  ...
  historyList = function(properties) {
    var $this, dataToSend, settings;
    $this = this;
    settings = properties;
    dataToSend = {
      personfrom: 0,
    ...
    return $this.getList = function(clear, startTime, inject) {
      if (!inject) {
        inject = "append";
      }
      return dataToSend = {
