...
<cfcomponent displayname="AttendeeStatusGateway" output="false">
	<cffunction name="init" access="public" output="false" returntype="_com.AttendeeStatus.AttendeeStatusGateway">
	...
	<cffunction name="getByAttributes" access="public" output="false" returntype="query">
		<cfargument name="AttendeeStatusID" type="numeric" required="false" />
		...
		<cfif structKeyExists(arguments,"AttendeeStatusID") and len(arguments.AttendeeStatusID)>
			AND	AttendeeStatusID = <cfqueryparam value="#arguments.AttendeeStatusID#" CFSQLType="cf_sql_integer" />
		</cfif>
