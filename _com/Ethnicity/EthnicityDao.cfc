...
<cfcomponent displayname="EthnicityDAO" hint="table ID column = EthnicityID">

	<cffunction name="init" access="public" output="false" returntype="_com.Ethnicity.EthnicityDAO">
	...
	<cffunction name="create" access="public" output="false" returntype="boolean">
		...
		<cftry>
			<cfquery name="qCreate" datasource="#variables.dsn#" result="CreateResult">
				...
				VALUES
					(
					<cfqueryparam value="#arguments.Ethnicity.getEthnicityID()#" CFSQLType="cf_sql_integer" />,
					<cfqueryparam value="#arguments.Ethnicity.getName()#" CFSQLType="cf_sql_varchar" null="#not len(arguments.Ethnicity.getName())#" />,
					<cfqueryparam value="#arguments.Ethnicity.getDescription()#" CFSQLType="cf_sql_varchar" null="#not len(arguments.Ethnicity.getDescription())#" />,
	...
	<cffunction name="read" access="public" output="false" returntype="_com.Ethnicity.Ethnicity">
		<cfargument name="Ethnicity" type="_com.Ethnicity.Ethnicity" required="true" />
	...
	<cffunction name="save" access="public" output="false" returntype="boolean">
		...
		<cfif exists(arguments.Ethnicity)>
			<cfset success = update(arguments.Ethnicity) />
		<cfelse>
			<cfset success = create(arguments.Ethnicity) />
		</cfif>
