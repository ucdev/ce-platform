...
<cfcomponent displayname="Budget" output="false">
	<!---
	PROPERTIES
	--->
	...
	--->
	<cffunction name="init" access="public" returntype="_com.ActivityFinance.Budget" output="false">
		<cfargument name="BudgetID" type="string" required="false" default="" />
		...
		<!--- run setters --->
		<cfset setBudgetID(arguments.BudgetID) />
	...
	PUBLIC FUNCTIONS
	--->
	<cffunction name="setMemento" access="public" returntype="_com.ActivityFinance.Budget" output="false">
	...
	<cffunction name="validate" access="public" returntype="array" output="false">
		...
		<!--- BudgetID --->
		<cfif (len(trim(getBudgetID())) AND NOT isNumeric(trim(getBudgetID())))>
			<cfset thisError.field = "BudgetID" />
			<cfset thisError.type = "invalidType" />
			<cfset thisError.message = "BudgetID is not numeric" />
		...
		<cfif (NOT len(trim(getEntryTypeID())))>
			...
			<cfset thisError.type = "required" />
			<cfset thisError.message = "Budget Type is required" />
			<cfset arrayAppend(errors,duplicate(thisError)) />
		</cfif>
		<cfif (len(trim(getEntryTypeID())) AND NOT isNumeric(trim(getEntryTypeID())))>
			<cfset thisError.field = "EntryTypeID" />
			<cfset thisError.type = "invalidType" />
			<cfset thisError.message = "Budget Type is not numeric" />
			<cfset arrayAppend(errors,duplicate(thisError)) />
		</cfif>
	...
	ACCESSORS
	--->
	<cffunction name="setBudgetID" access="public" returntype="void" output="false">
		<cfargument name="BudgetID" type="string" required="true" />
		<cfset variables.instance.BudgetID = arguments.BudgetID />
	</cffunction>
	<cffunction name="getBudgetID" access="public" returntype="string" output="false">
		<cfreturn variables.instance.BudgetID />
	</cffunction>
