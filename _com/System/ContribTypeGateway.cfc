...
<cfcomponent displayname="ContribTypeGateway" output="false">
	<cffunction name="init" access="public" output="false" returntype="_com.System.ContribTypeGateway">
	...
	<cffunction name="getByAttributes" access="public" output="false" returntype="query">
		<cfargument name="ContribTypeID" type="numeric" required="false" />
		...
		<cfif structKeyExists(arguments,"ContribTypeID") and len(arguments.ContribTypeID)>
			AND	ContribTypeID = <cfqueryparam value="#arguments.ContribTypeID#" CFSQLType="cf_sql_integer" />
		</cfif>
