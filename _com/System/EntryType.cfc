<cfcomponent displayname="EntryType" output="false">
	<!---
	PROPERTIES
	--->
	...
	--->
	<cffunction name="init" access="public" returntype="_com.System.EntryType" output="false">
		<cfargument name="EntryTypeID" type="string" required="false" default="" />
		<cfargument name="Name" type="string" required="false" default="" />
		<cfargument name="ExpenseFlag" type="string" required="false" default="" />
		...
		<cfset setExpenseFlag(arguments.ExpenseFlag) />
	...
	PUBLIC FUNCTIONS
	--->
	<cffunction name="setMemento" access="public" returntype="_com.System.EntryType" output="false">
	...
	<cffunction name="validate" access="public" returntype="array" output="false">
		...
		<!--- EntryTypeID --->
		<cfif (len(trim(getEntryTypeID())) AND NOT isNumeric(trim(getEntryTypeID())))>
			<cfset thisError.field = "EntryTypeID" />
			<cfset thisError.type = "invalidType" />
			<cfset thisError.message = "EntryTypeID is not numeric" />
		...
		<!--- ExpenseFlag --->
		<cfif (len(trim(getExpenseFlag())) AND NOT IsSimpleValue(trim(getExpenseFlag())))>
			<cfset thisError.field = "ExpenseFlag" />
			<cfset thisError.type = "invalidType" />
			<cfset thisError.message = "ExpenseFlag is not a string" />
			<cfset arrayAppend(errors,duplicate(thisError)) />
		</cfif>
		<cfif (len(trim(getExpenseFlag())) GT 1)>
			<cfset thisError.field = "ExpenseFlag" />
			<cfset thisError.type = "tooLong" />
			<cfset thisError.message = "ExpenseFlag is too long" />
			<cfset arrayAppend(errors,duplicate(thisError)) />
		</cfif>
	...
	<cffunction name="setExpenseFlag" access="public" returntype="void" output="false">
		<cfargument name="ExpenseFlag" type="string" required="true" />
		<cfset variables.instance.ExpenseFlag = arguments.ExpenseFlag />
	</cffunction>
	<cffunction name="getExpenseFlag" access="public" returntype="string" output="false">
		<cfreturn variables.instance.ExpenseFlag />
	</cffunction>
