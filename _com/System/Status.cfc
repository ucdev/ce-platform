<cfcomponent displayname="Status" output="false">
	...
	--->
	<cffunction name="init" access="public" returntype="_com.System.Status" output="false">
	...
	PUBLIC FUNCTIONS
	--->
	<cffunction name="setMemento" access="public" returntype="_com.System.Status" output="false">
