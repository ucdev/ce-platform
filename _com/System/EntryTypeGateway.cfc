<cfcomponent displayname="EntryTypeGateway" output="false">
	<cffunction name="init" access="public" output="false" returntype="_com.System.EntryTypeGateway">
	...
	<cffunction name="getByAttributes" access="public" output="false" returntype="query">
		...
		<cfargument name="ExpenseFlag" type="string" required="false" />
		...
		<cfif structKeyExists(arguments,"ExpenseFlag") and len(arguments.ExpenseFlag)>
			AND	ExpenseFlag = <cfqueryparam value="#arguments.ExpenseFlag#" CFSQLType="cf_sql_char" />
		</cfif>
