...
<cfcomponent displayname="ContributorGateway" output="false">
	<cffunction name="init" access="public" output="false" returntype="_com.system.ContributorGateway">
	...
	<cffunction name="getByAttributes" access="public" output="false" returntype="query">
		<cfargument name="ContributorID" type="numeric" required="false" />
		...
		<cfif structKeyExists(arguments,"ContributorID") and len(arguments.ContributorID)>
			AND	ContributorID = <cfqueryparam value="#arguments.ContributorID#" CFSQLType="cf_sql_integer" />
		</cfif>
