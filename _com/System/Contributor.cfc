...
<cfcomponent displayname="Contributor" output="false">
	<!---
	PROPERTIES
	--->
	...
	--->
	<cffunction name="init" access="public" returntype="_com.system.Contributor" output="false">
		<cfargument name="ContributorID" type="string" required="false" default="" />
		...
		<!--- run setters --->
		<cfset setContributorID(arguments.ContributorID) />
	...
	PUBLIC FUNCTIONS
	--->
	<cffunction name="setMemento" access="public" returntype="_com.system.Contributor" output="false">
	...
	<cffunction name="validate" access="public" returntype="array" output="false">
		...
		<!--- ContributorID --->
		<cfif (len(trim(getContributorID())) AND NOT isNumeric(trim(getContributorID())))>
			<cfset thisError.field = "ContributorID" />
			<cfset thisError.type = "invalidType" />
			<cfset thisError.message = "ContributorID is not numeric" />
	...
	ACCESSORS
	--->
	<cffunction name="setContributorID" access="public" returntype="void" output="false">
		<cfargument name="ContributorID" type="string" required="true" />
		<cfset variables.instance.ContributorID = arguments.ContributorID />
	</cffunction>
	<cffunction name="getContributorID" access="public" returntype="string" output="false">
		<cfreturn variables.instance.ContributorID />
	</cffunction>
