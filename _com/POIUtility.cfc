...
<cfcomponent
	...
	<cffunction name="GetCellStyle" access="private" returntype="any" output="false"
		...
		<cfscript>
			...
			if (Val( ARGUMENTS.CSS[ "border-bottom-width" ] )){
				...
				if (ListFindNoCase(COLORS, ARGUMENTS.CSS[ "border-bottom-color" ] )){
			...
			if (Val( ARGUMENTS.CSS[ "border-left-width" ] )){
				...
				// Check for a border color.
				if (ListFindNoCase( COLORS, ARGUMENTS.CSS[ "border-left-color" ] )){
			...
			if (Val( ARGUMENTS.CSS[ "border-right-width" ] )){
				...
				// Check for a border color.
				if (ListFindNoCase( COLORS, ARGUMENTS.CSS[ "border-right-color" ] )){
			...
			if (Val( ARGUMENTS.CSS[ "border-top-width" ] )){
				...
				// Check for a border color.
				if (ListFindNoCase( COLORS, ARGUMENTS.CSS[ "border-top-color" ] )){
			...
			// Check for color.
			if (ListFindNoCase( COLORS, ARGUMENTS.CSS[ "color" ] )){
	...
	<cffunction name="WriteExcel" access="public" returntype="void" output="true"
	...
	<cffunction name="WriteSingleExcel" access="public" returntype="void" output="true"
