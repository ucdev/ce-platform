...
<cfcomponent displayname="Report" output="false">
	...
	--->
	<cffunction name="init" access="public" returntype="_com.Report.Report" output="false">
	...
	PUBLIC FUNCTIONS
	--->
	<cffunction name="setMemento" access="public" returntype="_com.Report.Report" output="false">
