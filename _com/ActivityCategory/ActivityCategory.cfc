<cfcomponent displayname="ActivityCategory" output="false">
	...
	--->
	<cffunction name="init" access="public" returntype="_com.ActivityCategory.ActivityCategory" output="false">
		<cfargument name="Activity_CategoryID" type="string" required="false" default="" />
		...
		<!--- run setters --->
		<cfset setActivity_CategoryID(arguments.Activity_CategoryID) />
	...
	PUBLIC FUNCTIONS
	--->
	<cffunction name="setMemento" access="public" returntype="_com.ActivityCategory.ActivityCategory" output="false">
	...
	<cffunction name="validate" access="public" returntype="array" output="false">
		...
		<!--- Activity_CategoryID --->
		<cfif (len(trim(getActivity_CategoryID())) AND NOT isNumeric(trim(getActivity_CategoryID())))>
			<cfset thisError.field = "Activity_CategoryID" />
			<cfset thisError.type = "invalidType" />
			<cfset thisError.message = "Activity_CategoryID is not numeric" />
	...
	ACCESSORS
	--->
	<cffunction name="setActivity_CategoryID" access="public" returntype="void" output="false">
		<cfargument name="Activity_CategoryID" type="string" required="true" />
		<cfset variables.instance.Activity_CategoryID = arguments.Activity_CategoryID />
	</cffunction>
	<cffunction name="getActivity_CategoryID" access="public" returntype="string" output="false">
		<cfreturn variables.instance.Activity_CategoryID />
	</cffunction>
