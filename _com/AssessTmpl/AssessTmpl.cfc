...
<cfcomponent displayname="AssessTmpl" output="false">
	<!---
	PROPERTIES
	--->
	...
	--->
	<cffunction name="init" access="public" returntype="_com.AssessTmpl.AssessTmpl" output="false">
		<cfargument name="AssessTmplID" type="string" required="false" default="" />
		...
		<!--- run setters --->
		<cfset setAssessTmplID(arguments.AssessTmplID) />
	...
	PUBLIC FUNCTIONS
	--->
	<cffunction name="setMemento" access="public" returntype="_com.AssessTmpl.AssessTmpl" output="false">
	...
	<cffunction name="validate" access="public" returntype="array" output="false">
		...
		<!--- AssessTmplID --->
		<cfif (len(trim(getAssessTmplID())) AND NOT isNumeric(trim(getAssessTmplID())))>
			<cfset thisError.field = "AssessTmplID" />
			<cfset thisError.type = "invalidType" />
			<cfset thisError.message = "AssessTmplID is not numeric" />
	...
	ACCESSORS
	--->
	<cffunction name="setAssessTmplID" access="public" returntype="void" output="false">
		<cfargument name="AssessTmplID" type="string" required="true" />
		<cfset variables.instance.AssessTmplID = arguments.AssessTmplID />
	</cffunction>
	<cffunction name="getAssessTmplID" access="public" returntype="string" output="false">
		<cfreturn variables.instance.AssessTmplID />
	</cffunction>
