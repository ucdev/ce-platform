<cfcomponent displayname="CreditDAO" hint="table ID column = CreditID">
	...
	<cffunction name="init" access="public" output="false" returntype="_com.Credit.CreditDAO">
	...
	<cffunction name="create" access="public" output="false" returntype="boolean">
		<cfargument name="Credit" type="_com.Credit.Credit" required="true" />
	...
	<cffunction name="read" access="public" output="false" returntype="_com.Credit.Credit">
		<cfargument name="Credit" type="_com.Credit.Credit" required="true" />
