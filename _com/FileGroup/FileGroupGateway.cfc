<cfcomponent displayname="FileGroupGateway" output="false">
	<cffunction name="init" access="public" output="false" returntype="_com.FileGroup.FileGroupGateway">
	...
	<cffunction name="getByAttributes" access="public" output="false" returntype="query">
		...
		<cfargument name="FileGroupTypeID" type="numeric" required="false" />
		...
		<cfif structKeyExists(arguments,"FileGroupTypeID") and len(arguments.FileGroupTypeID)>
			AND	FileGroupTypeID = <cfqueryparam value="#arguments.FileGroupTypeID#" CFSQLType="cf_sql_integer" />
		</cfif>
