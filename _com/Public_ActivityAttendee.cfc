	...
	<cffunction name="getAttendeeDate" hint="Returns requested date information for provided attendee." access="Public" output="false">
		...
		<cfswitch expression="#Arguments.Type#">
			<cfcase value="1">
				<cfquery name="AttendeeInfo" datasource="#Application.Settings.DSN#">
					SELECT 
						...
						RegisterDate,
						TermDate,
						CompleteDate AS currStatusDate,
						StatusId,
						1 AS currStatusId
					FROM ce_Attendee
					WHERE 
				...
				<cfset status.setStatusMsg("COMPLETE (" & DateFormat(AttendeeInfo.currStatusDate, "MM/DD/YYYY") & ")")>
			</cfcase>
			<cfcase value="2">
				<cfquery name="AttendeeInfo" datasource="#Application.Settings.DSN#">
					SELECT 
						...
						RegisterDate,
						TermDate,
						RegisterDate AS currStatusDate,
						StatusId,
						3 AS currStatusId
					FROM ce_Attendee
					WHERE 
			...
			<cfcase value="3">
				...
				<cfset status.setStatusMsg("REGISTERED (" & DateFormat(AttendeeInfo.currStatusDate, "MM/DD/YYYY") & ")")>
			</cfcase>
			<cfcase value="4">
				<cfquery name="AttendeeInfo" datasource="#Application.Settings.DSN#">
					SELECT 
						...
						RegisterDate,
						TermDate,
						TermDate AS currStatusDate,
						StatusId,
						StatusId AS currStatusId,
						4 AS currStatusId
					FROM ce_Attendee
					WHERE 
						attendeeId = <cfqueryparam value="#Arguments.attendeeId#" cfsqltype="cf_sql_integer" />
				</cfquery>
				<cfset status.setStatusMsg("FAILED (" & DateFormat(AttendeeInfo.currStatusDate, "MM/DD/YYYY") & ")")>
			</cfcase>
			<cfdefaultcase>
				<cfquery name="AttendeeInfo" datasource="#Application.Settings.DSN#">
					SELECT 
						...
						TermDate,
						CASE statusId
							WHEN 1 THEN completeDate
							WHEN 2 THEN registerDate
							WHEN 3 THEN registerDate
							WHEN 4 THEN termDate
		...
		<cfif isQuery(AttendeeInfo)>
			<cfset status.setData({
								'CURRSTATUSID': AttendeeInfo.currStatusId,
								'CURRSTATUSDATE': DateFormat(AttendeeInfo.currStatusDate, "MM/DD/YYYY"),
								'COMPLETEDATE': DateFormat(AttendeeInfo.completeDate, "MM/DD/YYYY"),
								'REGISTERDATE': DateFormat(AttendeeInfo.registerDate, "MM/DD/YYYY"),
								'STATUSID': AttendeeInfo.StatusId,
								'TERMDATE': DateFormat(AttendeeInfo.termDate, "MM/DD/YYYY"),
								'month': numberFormat(month(AttendeeInfo.currStatusDate), "00"),
								'day': numberFormat(day(AttendeeInfo.currStatusDate), "00"),
								'year':year(AttendeeInfo.currStatusDate)
								}) />
	...
	<cffunction name="saveAttendeeDate" hint="Saves date info for attendee to provided attendee db field." access="Public">
		...
		<cfswitch expression="#Arguments.Type#">
			<cfcase value="1">
				...
				<cfset status.setData({ CompleteDate: "#arguments.DateValue#", currStatusId: 1 })>
			</cfcase>
			<cfcase value="2">
				<cfquery name="UpdateAttendee" datasource="#Application.Settings.DSN#">
					UPDATE ce_Attendee
				...
				<cfset status.setData({ RegisterDate: "#arguments.DateValue#", currStatusId: 2 })>
			</cfcase>
			<cfcase value="3">
				<cfquery name="UpdateAttendee" datasource="#Application.Settings.DSN#">
					UPDATE ce_Attendee
				...
				<cfset status.setData({ RegisterDate: "#arguments.DateValue#", currStatusId: 3 })>
			</cfcase>
			<cfcase value="4">
				<cfquery name="UpdateAttendee" datasource="#Application.Settings.DSN#">
					UPDATE ce_Attendee
				...
				<cfset status.setData({ TermDate: "#arguments.DateValue#", currStatusId: 4 })>
			</cfcase>
			<cfdefaultcase>
